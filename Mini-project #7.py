...
class Ship:
    ...
    def shoot(self):
        ...
        a_missile = Sprite([self.pos[0] + 40, self.pos[1]], [self.vel[0] * move[0], self.vel[1] * move[1]], self.angle, 0, missile_image, missile_info, missile_sound)
...
def draw(canvas):
    ...
    # draw UI
    canvas.draw_text('Score: ' + str(score), (700, 40), 24, 'White')
...
def rock_spawner():
    ...
    a_rock.angle_vel = math.radians(random.randrange(-15, 15))
    
# keyboard input handlers
def keydown(key):
    
    if key == simplegui.KEY_MAP["left"]:
        my_ship.angle_vel -= math.radians(5)
